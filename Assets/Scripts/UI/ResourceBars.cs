...
public class ResourceBars : MonoBehaviour {
    ...
    public void Setup(LivingEntity owner, Action<ResourceType, float> resourceValueChangedDelegate) {
        ...
        bars[(int) ResourceType.Health].Setup(owner, ResourceType.Health, AttributeTypes.HealthMax, GameEvents.Health_Changed, resourceValueChangedDelegate);
        bars[(int) ResourceType.Mana].Setup(owner, ResourceType.Mana, AttributeTypes.ManaMax, GameEvents.Mana_Changed, resourceValueChangedDelegate);
    }
