...
public abstract class AreaTargetAbilityBase : CastAbilityBase {
    protected AreaTargetAbilityBase(Player owner, Ability.ID abilityID, Ability.Binding abilityBinding)
