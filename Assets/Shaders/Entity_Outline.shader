...
Shader "Custom/Entity_Outline"
{
	Properties
	{
		...
		_FirstOutlineColor("Outline color", Color) = (1, 0.8431, 0, 0.5)
		_FirstOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.05

		_SecondOutlineColor("Outline color", Color) = (1, 0.8431, 0, 1)
		_SecondOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.03
